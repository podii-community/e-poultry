import 'package:epoultry/features/pages/auth/login.dart';
import 'package:epoultry/features/pages/auth/otp_page.dart';
...
class VeterinaryOfficer extends StatefulWidget {
  ...
  @override
  State<VeterinaryOfficer> createState() => _VeterinaryOfficerState();
}
          ...
          child: Center(
            child: Column(
              ...
              children: [
                ...
                Text(
                  'Register as an veterinary officer.',
